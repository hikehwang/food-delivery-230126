...
pluralCaseList.push( {plural: "orders", pascal: "Orders"} )

pluralCaseList.push( {plural: "storeOrders", pascal: "StoreOrders"} )

pluralCaseList.push( {plural: "deliveries", pascal: "Deliveries"} )

pluralCaseList.push( {plural: "notifications", pascal: "Notification"} )



pluralCaseList.push( {plural: "statuses", pascal: "Status"} )
